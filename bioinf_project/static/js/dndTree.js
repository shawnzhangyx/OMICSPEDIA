treeJSON = d3.json("/static/flare.json", function(error, treeData) {
    ...
    // panning variables
    var panSpeed = 10;
    var panBoundary =5; // Within 20px from edges will pan when dragging.
    // Misc. variables
    var i = 0;
    var duration = 750;
    var root;
    ...
    var viewerWidth = 900- margin.right - margin.left;
    var viewerHeight = 400 - margin.top - margin.bottom;
