...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'users_notification', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='notifications', to=orm['users.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.user'
        db.delete_column(u'users_notification', 'user_id')
