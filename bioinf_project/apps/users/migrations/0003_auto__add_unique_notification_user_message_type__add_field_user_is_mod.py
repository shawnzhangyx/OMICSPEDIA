...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Notification', fields ['user', 'message', 'type']
        db.create_unique(u'users_notification', ['user_id', 'message', 'type'])

        # Adding field 'User.is_moderator'
        db.add_column(u'users_user', 'is_moderator',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Notification', fields ['user', 'message', 'type']
        db.delete_unique(u'users_notification', ['user_id', 'message', 'type'])

        # Deleting field 'User.is_moderator'
        db.delete_column(u'users_user', 'is_moderator')
