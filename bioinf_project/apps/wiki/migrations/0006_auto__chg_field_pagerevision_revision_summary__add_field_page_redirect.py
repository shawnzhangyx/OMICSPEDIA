...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PageRevision.revision_summary'
        db.alter_column(u'wiki_pagerevision', 'revision_summary', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Adding field 'Page.redirect_to'
        db.add_column(u'wiki_page', 'redirect_to',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wiki.Page'], unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PageRevision.revision_summary'
        db.alter_column(u'wiki_pagerevision', 'revision_summary', self.gf('django.db.models.fields.CharField')(max_length=20))
        # Deleting field 'Page.redirect_to'
        db.delete_column(u'wiki_page', 'redirect_to_id')
