...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wiki_userpage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='userpage', to=orm['wiki.Page'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='userpage', to=orm['users.User'])),
            ('edits', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('added', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('deleted', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'wiki', ['UserPage'])


    def backwards(self, orm):
        # Deleting model 'UserPage'
        db.delete_table(u'wiki_userpage')
