...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Page.comment_count'
        db.delete_column(u'wiki_page', 'comment_count')

        # Adding field 'Page.open_comment_count'
        db.add_column(u'wiki_page', 'open_comment_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Page.pending_comment_count'
        db.add_column(u'wiki_page', 'pending_comment_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Page.comment_count'
        db.add_column(u'wiki_page', 'comment_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Page.open_comment_count'
        db.delete_column(u'wiki_page', 'open_comment_count')

        # Deleting field 'Page.pending_comment_count'
        db.delete_column(u'wiki_page', 'pending_comment_count')
