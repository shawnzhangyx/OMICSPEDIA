...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vote.date'
        db.alter_column(u'utils_vote', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Vote.date'
        db.alter_column(u'utils_vote', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))
