...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'utils_comment', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 17, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.created'
        db.delete_column(u'utils_comment', 'created')
