...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tool'
        db.create_table(u'software_tool', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.OneToOneField')(related_name='software', unique=True, to=orm['wiki.Page'])),
            ...
            ('OS', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('citation', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('author_affiliation', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('author_contacts', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('first_release_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('latest_release_date', self.gf('django.db.models.fields.DateField')(null=True)),
        ))
        db.send_create_signal(u'software', ['Tool'])


    def backwards(self, orm):
        # Deleting model 'Tool'
        db.delete_table(u'software_tool')
